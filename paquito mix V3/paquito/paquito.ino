...
///>>>>>>> main
    ...
    for (auto& ism : isms) {
      ...
      madgwick.updateIMU(gx / factor, gy / factor, gz / factor, ax, ay, az);
...
//>>>>>>> main
      //madgwick.updateIMU(omega_roll, omega_pitch, omega_yaw, accX, accY, accZ);
       float madw_roll  = madgwick.getRoll()* 180.0 / M_PI;
       float madw_pitch = madgwick.getPitch()* 180.0 / M_PI;
       float madw_yaw   = madgwick.getYaw()* 180.0 / M_PI;
